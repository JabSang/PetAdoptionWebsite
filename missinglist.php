...
// Query to get the data from the missing_pets table
$sql = "SELECT * FROM missing_pets";
...
<head>
    ...
    <link href="css/missinglist.css" rel="stylesheet">
</head>
    ...
    <div class="container py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Missing Pet</h6>
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <div>
                            <a class="nav-link " href="missingform.html">Post Missing Pet</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                    <div class="p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-bookmarks me-2"></i>' . $row["owner_name"] . '</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>Date Posted: ' . $row["date_posted"] . '</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">
                                            Name: ' . $row["pet_name"] . ' <br>
                                            Species: ' . $row["species"] . ' <br>
                                            Age: ' . $row["age"] . ' <br>
                                            Contact Me: ' . $row["contact"] . '
                                        </h5>
                                        <p>' . $row["description"] . '</p>
